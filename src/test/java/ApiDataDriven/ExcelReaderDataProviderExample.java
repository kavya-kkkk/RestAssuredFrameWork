...
public class ExcelReaderDataProviderExample {
	...
	public void createUser(String method, String jsonbody, String url, String contenttype, double status,
...
//POST
...

		{
			...
			String requestBody = jsonbody;
			given().contentType(contenttype).body(requestBody).when().put(url).then().statusCode(200);
...
//DELETE
	...
	/*
	 * public void updateUser(String jsonbody,String url, String contenttype,String
	 * name,String email ) { /* {
	 * \"name\": \"morpheus\", \"email\": \"zion resident\" }" { "name": "morpheus",
	 * "job": "zion resident" } String requestBody = jsonbody; given()
	 * .contentType(contenttype) .body(requestBody) .when() .put(url)
	 * //https://reqres.in/api/users/2 .then() .statusCode(200) .assertThat()
	 ...
	 * System.out.println(response.asPrettyString());
	 * System.out.println("url for get "+ url); int code=response.getStatusCode();
	 * System.out.println("status code is "+code); Assert.assertEquals(code, 200);
	 * 
	 * }
	 */
	 ...
	 * String url, String contenttype) { String requestBody = jsonbody; given()
	 * .contentType(contenttype) . body(requestBody) .when() .post(url) .then()
	 * .statusCode(200) .assertThat(); // .body("name", equalTo("John")) //
	 * .body("email", equalTo("john@example.com")); }
	 */
...
//update
	...
	/*
	 * @Test(dataProvider = "excelData") public void updateUser(String
	 * jsonbody,String url, String contenttype,String name,String email ) {
	 * 
	 * String requestBody = jsonbody; given() .contentType(contenttype)
	 * .body(requestBody) .when() .put(url) .then() .statusCode(200) .assertThat()
	 * .body("name", equalTo(name)) .body("email", equalTo(email)); }
	 */
